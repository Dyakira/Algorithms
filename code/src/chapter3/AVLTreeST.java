...
public class AVLTreeST<K extends Comparable<K>, V> {
    ...
    private AVLNode<K,V> balance(AVLNode<K,V> n) {
        // THIS ONLY FIXES THE TOP LEVEL HEIGHT, DOES NOTHING TO BALANCE THE TREE
    ...
    private String inOrder(AVLNode<K,V> n) {
        // THIS OBVIOUSLY DOESN'T WORK. YOU NEED TO IMPLEMENT IT.
        return n.toString();
    }
